...
use yew::{classes, function_component, html, use_effect_with_deps, use_state, Html};
        ...
        use_effect_with_deps(
            move |_| {
                spawn_local(async move {
                    let fetched_todos: PaginatedResult<TodoEntity> =
                        Request::get("https://api.todo.localhost/api/v1/todos")
                            .send()
                            .await
                            .unwrap()
                            .json()
